 ...
 */
export default function useSeo({ title, description, image, type = 'website', noindex = false, jsonLd, canonicalPath } = {}) {
  ...
  }, [title, description, image, type, noindex, ld, canonicalPath]);
}
